...
Swagger example: [https://editor.swagger.io/](https://editor.swagger.io/)

### API Security - Top 10 Best Practices

1. Use a strong authentication and authorization solution
...
#### Some Principles for Securing REST APIs
